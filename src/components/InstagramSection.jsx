      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col items-center text-center mb-12">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h2 className="font-serif text-4xl md:text-5xl text-[#4A2805] font-bold">
        ...
        {SNAPWIDGET_URL ? (
          ...
          <div className="bg-[#EBE4D8] rounded-xl p-12 text-center">
            ...
            <p className="text-[#4A2805]/70 mb-6 text-base max-w-md mx-auto">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-block bg-[#4A2805] text-[#F8F5F0] px-8 py-3 rounded-full font-medium hover:bg-[#A95C45] transition-colors duration-300"
            >
        ...
        <div className="text-center mt-8">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-2 text-[#4A2805] font-semibold hover:text-[#A95C45] transition-colors underline"
          >
